...
///
/// **Two steps introduce ASCII, not one** (#719). The leading NFKC is the obvious one;
/// the confusable fold is the second and reaches characters NFKC leaves alone. `U+2236
