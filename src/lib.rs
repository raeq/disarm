...
// Curated language/script metadata (generated by scripts/gen_metadata.py).
mod contraction;
mod metadata;
...
fn _core(m: &Bound<'_, PyModule>) -> PyResult<()> {
    ...
    m.add_function(wrap_pyfunction!(py::scripts::_has_bidi_control, m)?)?;
    ...
    m.add_function(wrap_pyfunction!(py::presets::_skeleton_key, m)?)?;
