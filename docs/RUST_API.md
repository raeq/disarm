...
| `0.16.x` → `0.17.0` | Read the changelog's **Upgrade notes** first: `KEY_SCHEMA_VERSION` goes 9 → 10 in one step, and the table there names the twelve changes it records and what each moves. |
