...
#[pyfunction]
#[pyo3(signature = (hostname, *, contractions=false))]
pub fn _is_suspicious_hostname(hostname: &str, contractions: bool) -> (bool, HostnameAnalysis) {
    ...
    let analysis = crate::api::analyze_hostname_with(hostname, contractions);
