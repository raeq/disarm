    ...
    *something that is not that digit* — usually a Latin letter (Devanagari zero to ``o``,
    ...
    with open(path, "w", encoding="utf-8") as f:
        f.write(
            ...
            f"TR39 folds it to something else — usually a Latin letter, but also "
            f"punctuation ('.') and one two-character sequence ('rn'). The value here is "
            f"TR39's target, applied only under digit_policy='tr39'. Generated by "
