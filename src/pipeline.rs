...
const STEP_ORDER: &[(PipelineSteps, &str)] = &[
    ...
    // input as written, and 65 code points get a different answer than
    // `normalize_confusables` gives standalone (5 for the Cyrillic target). That is the
    // order this pipeline wants — 43 of the 65 are number forms and mathematical
