...
package com.disarm.kotlin

import com.disarm.AnomalyReport
import com.disarm.AutoLangInspection
import com.disarm.LangMeta
import com.disarm.Lexicon
import com.disarm.NormalizationForm
import com.disarm.Pipeline
import com.disarm.Platform
import com.disarm.SanitizeFilenameOptions
import com.disarm.ScriptMeta
import com.disarm.SlugOptions
import com.disarm.TargetScript
import com.disarm.TransliterateOptions
import com.disarm.Untranslatable
import com.disarm.Disarm as JDisarm

/**
 * Idiomatic Kotlin surface for disarm — thin extension functions over the Java
 * facade ([com.disarm.Disarm]), which owns the JNI shim and native loader.
 *
