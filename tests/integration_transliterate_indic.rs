...
fn devanagari_bare_consonant() {
    let result = common::transliterate("क", None, ErrorMode::Ignore, "", false, false, false);
    assert_eq!(result, "ka");
}

#[test]
fn devanagari_virama() {
    let result = common::transliterate("क्", None, ErrorMode::Ignore, "", false, false, false);
    assert_eq!(result, "k");
}

#[test]
fn devanagari_matra() {
    let result = common::transliterate("की", None, ErrorMode::Ignore, "", false, false, false);
    assert_eq!(result, "ki");
}

#[test]
fn devanagari_namaste() {
    let result = common::transliterate("नमस्ते", None, ErrorMode::Ignore, "", false, false, false);
    assert_eq!(result, "namaste");
}

#[test]
fn bengali_basic() {
    let result = common::transliterate("কলকাতা", None, ErrorMode::Ignore, "", false, false, false);
    assert_eq!(result, "kalakata");
}

#[test]
fn tamil_basic() {
    let result = common::transliterate("தமிழ்", None, ErrorMode::Ignore, "", false, false, false);
    assert_eq!(result, "tamizh");
}

#[test]
fn indic_digits() {
    let result = common::transliterate("१२३", None, ErrorMode::Ignore, "", false, false, false);
...
fn indic_all_scripts_produce_ascii() {
    ...
    for sample in &samples {
        let result =
            common::transliterate(sample, None, ErrorMode::Ignore, "", false, false, false);
        assert!(
            result.is_ascii(),
...
#[test]
fn devanagari_dilli() {
    let result = common::transliterate("दिल्ली", None, ErrorMode::Ignore, "", false, false, false);
    assert_eq!(result, "dilli");
}

#[test]
fn devanagari_mumbai() {
    let result = common::transliterate("मुम्बई", None, ErrorMode::Ignore, "", false, false, false);
    assert_eq!(result, "mumbai");
}

#[test]
fn devanagari_consecutive_consonants() {
    let result = common::transliterate("कल", None, ErrorMode::Ignore, "", false, false, false);
    assert_eq!(result, "kala");
}

#[test]
fn devanagari_independent_vowels() {
    let result = common::transliterate("अइउ", None, ErrorMode::Ignore, "", false, false, false);
...
fn sinhala_bare_consonant() {
    let result =
        common::transliterate("\u{0D9A}", None, ErrorMode::Ignore, "", false, false, false);
    assert_eq!(result, "ka");
}
...
#[test]
fn sinhala_word() {
    let result = common::transliterate("සිංහල", None, ErrorMode::Ignore, "", false, false, false);
    assert_eq!(result, "simhala");
}

#[test]
fn sinhala_digits() {
    let result = common::transliterate("෧෨෩", None, ErrorMode::Ignore, "", false, false, false);
    assert_eq!(result, "123");
}
...
fn thai_consonants() {
    let result =
        common::transliterate("\u{0E01}", None, ErrorMode::Ignore, "", false, false, false);
    assert_eq!(result, "k");
}
...
fn lao_consonants() {
    let result =
        common::transliterate("\u{0E81}", None, ErrorMode::Ignore, "", false, false, false);
    assert_eq!(result, "k");
}
...
fn lao_composite_consonants() {
    assert_eq!(
        common::transliterate("\u{0EDC}", None, ErrorMode::Ignore, "", false, false, false,),
        "hn"
    );
    assert_eq!(
        common::transliterate("\u{0EDD}", None, ErrorMode::Ignore, "", false, false, false,),
        "hm"
    );
}
...
proptest! {
    ...
    fn prop_devanagari_produces_ascii(s in devanagari_text()) {
        let result = common::transliterate(&s, None, ErrorMode::Ignore, "", false, false, false);
    ...
    fn prop_indic_idempotent(s in any_indic_text()) {
        let once = common::transliterate(&s, None, ErrorMode::Ignore, "", false, false, false);
        let twice = common::transliterate(&once, None, ErrorMode::Ignore, "", false, false, false);
...
fn ethiopic_syllable_orders() {
    let r =
        |s| common::transliterate(s, None, ErrorMode::Ignore, "", false, false, false).into_owned();
...
fn ethiopic_ethiopia() {
    let result = common::transliterate("ኢትዮጵያ", None, ErrorMode::Ignore, "", false, false, false);
    assert_eq!(&*result, "ityopya");
}

#[test]
fn ethiopic_digits() {
    let result = common::transliterate("፩፪፫", None, ErrorMode::Ignore, "", false, false, false);
    assert_eq!(&*result, "123");
}
...
fn amharic_tsade_override() {
    ...
    let result = common::transliterate("ጸ", Some("am"), ErrorMode::Ignore, "", false, false, false);
    assert_eq!(&*result, "se");
}
...
fn amharic_tsade_alt_override() {
    ...
    let result = common::transliterate("ፀ", Some("am"), ErrorMode::Ignore, "", false, false, false);
    assert_eq!(&*result, "se");
}
...
fn amharic_pharyngeal_override() {
    ...
    let result = common::transliterate("ዐ", Some("am"), ErrorMode::Ignore, "", false, false, false);
    assert_eq!(&*result, "'e");
}
...
fn amharic_default_unchanged() {
    ...
    let result = common::transliterate("ጸ", None, ErrorMode::Ignore, "", false, false, false);
...
fn myanmar_consonant() {
    let result = common::transliterate("က", None, ErrorMode::Ignore, "", false, false, false);
    assert_eq!(&*result, "ka");
}

#[test]
fn myanmar_virama_strips_a() {
    let result = common::transliterate("န်", None, ErrorMode::Ignore, "", false, false, false);
    assert_eq!(&*result, "n");
}

#[test]
fn myanmar_dependent_vowel() {
    let result = common::transliterate("ကိ", None, ErrorMode::Ignore, "", false, false, false);
    assert_eq!(&*result, "ki");
}

#[test]
fn myanmar_digits() {
    let result = common::transliterate("၀၁၉", None, ErrorMode::Ignore, "", false, false, false);
    assert_eq!(&*result, "019");
}

#[test]
fn myanmar_produces_ascii() {
    let result = common::transliterate("မြန်မာ", None, ErrorMode::Ignore, "", false, false, false);
    assert!(result.is_ascii());
}
...
#[test]
fn khmer_consonant() {
    let result = common::transliterate("ក", None, ErrorMode::Ignore, "", false, false, false);
    assert_eq!(&*result, "ka");
}

#[test]
fn khmer_cambodia() {
    let result = common::transliterate("កម្ពុជា", None, ErrorMode::Ignore, "", false, false, false);
    assert_eq!(&*result, "kampucha");
}

#[test]
fn khmer_coeng_stacks() {
    let result = common::transliterate("ក្រ", None, ErrorMode::Ignore, "", false, false, false);
    assert_eq!(&*result, "kra");
}

#[test]
fn khmer_digits() {
    let result = common::transliterate("០១៩", None, ErrorMode::Ignore, "", false, false, false);
    assert_eq!(&*result, "019");
}
...
fn tibetan_consonant() {
    let result = common::transliterate("ཀ", None, ErrorMode::Ignore, "", false, false, false);
    assert_eq!(&*result, "ka");
}

#[test]
fn tibetan_vowel_sign() {
    let result = common::transliterate("ཀི", None, ErrorMode::Ignore, "", false, false, false);
    assert_eq!(&*result, "ki");
}

#[test]
fn tibetan_om() {
    let result = common::transliterate("ༀ", None, ErrorMode::Ignore, "", false, false, false);
    assert_eq!(&*result, "om");
}

#[test]
fn tibetan_digits() {
    let result = common::transliterate("༠༡༩", None, ErrorMode::Ignore, "", false, false, false);
    assert_eq!(&*result, "019");
}

#[test]
fn tibetan_produces_ascii() {
    let result = common::transliterate("བོད", None, ErrorMode::Ignore, "", false, false, false);
    assert!(result.is_ascii());
}
...
proptest! {
    ...
    fn prop_ethiopic_produces_ascii(text in ethiopic_text()) {
        let result = common::transliterate(&text, None, ErrorMode::Ignore, "", false, false, false);
        prop_assert!(result.is_ascii(), "Non-ASCII from Ethiopic: {:?}", result);
    }

    #[test]
    fn prop_ethiopic_idempotent(text in ethiopic_text()) {
        let once = common::transliterate(&text, None, ErrorMode::Ignore, "", false, false, false);
        let twice = common::transliterate(&once, None, ErrorMode::Ignore, "", false, false, false);
        prop_assert_eq!(&*once, &*twice);
    }
...
fn auto_lang_thai_matches_explicit_th() {
    ...
    let explicit =
        common::transliterate(text, Some("th"), ErrorMode::Ignore, "", false, false, false);
