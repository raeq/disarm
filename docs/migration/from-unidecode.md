...
- **48,297** mapped by translit vs **47,408** by Unidecode — translit has broader coverage overall, with 1,046 characters only translit maps vs 157 only Unidecode maps
