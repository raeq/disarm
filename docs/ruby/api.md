...
#      has_invisible: false, compat_fold: false, cross_label_script: false,
...
Both defaults are the core's, `Disarm::DEFAULT_ZALGO_MAX_MARKS` and
`Disarm::DEFAULT_ZALGO_THRESHOLD`, and equal on purpose (#788): `strip_zalgo` never
